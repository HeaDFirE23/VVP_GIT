...
{
    int c{ 1 }, k{ 0 }, buff{ 0 };
    vector <int> A = { 1, 1, 1, 2, 2, 4, 21, 3, 5, 5, 5 }, B, C;
...
void zd2()
{
    vector <int> A = { 1,1,1,2,2,3,3,3,4,5,5,5,6,7 };
    for (int i{ 0 }; i < A.size(); i++)
    {
        cout << A[i] << " ";
    }
...
void zd3()
{
    vector <int> A = { 1,1,1,2,2,3,3,3,4,5,5,5,6,6 };
    for (int i{ 0 }; i < A.size(); i++)
    {
        cout << A[i] << " ";
    }
...
{
    int max{ 0 }, x, y;
    vector<vector<int>> A{ {-1,1}, {-5,7}, {-2,1} };
    for (int i{ 0 }; i < A.size(); i++)
    {
